...
void main(){ // main 스레드 갖는 함수
  ...
  count = "123명";
  const PI = 3.1459;        // JS처럼 const 상수(런파일 시점)
  final country = "대한민국"; // JAVA final 상수(컴파일 시점)
