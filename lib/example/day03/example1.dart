...
void getEvent () async { // dart 의 람다식/익명함수는 ()=>{} , (){}
  ...
  }catch(e){print("[GET] 실패 ${e}"); } // dart 의 문자열 템플릿 vs JS `백틱
}
// [2] POST 방식의 요청 함수
void postEvent () async{
  try{
    ...
    // final response = await dio.post("https://jsonplaceholder.typicode.com/posts", data: 전송할데이터);
...
void main(){
  ...
  getEvent(); // [1] 호출
  postEvent();// [2] 호출
  // 1. DIO 설치 : pubspec.yaml 파일내 30번줄 저옫에 'dependencies: '
